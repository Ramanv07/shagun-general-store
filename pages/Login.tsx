...
export const Login: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
        ...
        alert('Authentication failed. Use admin@shagun.com / admin123 or user@shagun.com / user123');
    } finally {
        setLoading(false);
    }
  };
        ...
        <div className="glass p-8 md:p-12 rounded-2xl w-full max-w-md relative z-10">
            ...
            {isLogin && (
                <div className="mt-4 p-3 bg-white/5 rounded text-xs text-gray-400 text-center">
                    <p>Demo Admin: admin@shagun.com / admin123</p>
                    <p>Demo User: user@shagun.com / user123</p>
                </div>
            )}
        </div>
    </div>
